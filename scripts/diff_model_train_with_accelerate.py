...
def diff_model_train(
    ...
    noise_scheduler.add_noise = MethodType(partial(linear_interpolate, add_noise=True), noise_scheduler) # Option: linear_interpolate, triangular_interpolate, enc_dec_interpolate
